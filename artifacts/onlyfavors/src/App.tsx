...
function CompareCompanions() {
  const DEV_COMPANIONS_LOCAL = [
    { id: 'companion-maya',    displayName: 'Maya R.',    city: 'San Francisco',  serviceArea: 'SF Bay Area',          hourlyRate: 65, rating: 4.9, reviewCount: 47, activities: ['Museum visits', 'Coffee conversations', 'Gallery tours', 'Evening walks'],           biography: 'I believe good company starts with genuine curiosity.', responseTime: 'within 2h', instantBook: true,  verified: true, languages: ['English', 'Spanish'],             acceptanceRate: 92, memberSince: 'Jan 2024', totalBookings: 84 },
    { id: 'companion-jordan',  displayName: 'Jordan K.',  city: 'New York',       serviceArea: 'Manhattan & Brooklyn', hourlyRate: 75, rating: 4.8, reviewCount: 31, activities: ['Architecture walks', 'Restaurant dining', 'Bookstore visits'],                      biography: 'NYC guide and constant reader.',                      responseTime: 'within 1h', instantBook: false, verified: true, languages: ['English', 'French'],              acceptanceRate: 88, memberSince: 'Mar 2024', totalBookings: 62 },
    { id: 'companion-simone',  displayName: 'Simone A.',  city: 'Chicago',        serviceArea: 'Chicago metro',        hourlyRate: 60, rating: 4.9, reviewCount: 19, activities: ['Architecture tours', 'Jazz evenings', 'Museum visits', 'Lakeside walks'],           biography: 'Architecture nerd, jazz obsessive, and lifelong Chicagoan.', responseTime: 'within 3h', instantBook: false, verified: true, languages: ['English'],                   acceptanceRate: 85, memberSince: 'May 2024', totalBookings: 53 },
    { id: 'companion-alex',    displayName: 'Alex T.',    city: 'Seattle',        serviceArea: 'Seattle & Eastside',   hourlyRate: 70, rating: 4.7, reviewCount: 22, activities: ['Coffee conversations', 'Bookstore tours', 'Hiking', 'Market walks'],                biography: 'Pacific Northwest native with strong opinions on coffee.',  responseTime: 'within 2h', instantBook: true,  verified: true, languages: ['English', 'Japanese'],           acceptanceRate: 90, memberSince: 'Apr 2024', totalBookings: 44 },
    { id: 'companion-priya',   displayName: 'Priya M.',   city: 'Los Angeles',    serviceArea: 'LA metro',             hourlyRate: 80, rating: 4.9, reviewCount: 27, activities: ['Wine tasting', 'Hiking', 'Restaurant dining', 'Museum visits', 'Beach visits'], biography: 'Sommelier and trail runner. I make every outing feel intentional.', responseTime: 'within 1h', instantBook: true,  verified: true, languages: ['English', 'Hindi'],              acceptanceRate: 97, memberSince: 'Jan 2025', totalBookings: 114 },
    { id: 'companion-devon',   displayName: 'Devon H.',   city: 'Boston',         serviceArea: 'Greater Boston',       hourlyRate: 70, rating: 4.8, reviewCount: 18, activities: ['Jazz bars', 'Museum visits', 'Harbor walks', 'Coffee conversations'],              biography: 'Jazz musician and Boston historian.',                     responseTime: 'within 2h', instantBook: false, verified: true, languages: ['English'],                   acceptanceRate: 86, memberSince: 'Jul 2025', totalBookings: 53 },
    { id: 'companion-isadora', displayName: 'Isadora V.', city: 'Miami',          serviceArea: 'Miami-Dade',           hourlyRate: 65, rating: 4.9, reviewCount: 41, activities: ['Art walks', 'Beachside walks', 'Food & culture tours', 'Gallery visits'],          biography: 'Trilingual Miami local — art, food, and both coasts.',   responseTime: 'within 1h', instantBook: true,  verified: true, languages: ['English', 'Spanish', 'Portuguese'], acceptanceRate: 93, memberSince: 'Jun 2025', totalBookings: 78 },
    { id: 'companion-theo',    displayName: 'Theo L.',    city: 'Washington D.C.',serviceArea: 'DC metro',             hourlyRate: 72, rating: 4.7, reviewCount: 16, activities: ['Monument tours', 'Museum visits', 'Diplomatic dining', 'Gallery walks'],           biography: 'Historian, museum insider, and D.C. native.',            responseTime: 'within 3h', instantBook: false, verified: true, languages: ['English', 'French'],              acceptanceRate: 83, memberSince: 'Jul 2025', totalBookings: 29 },
    { id: 'companion-ruth',    displayName: 'Ruth K.',    city: 'Denver',         serviceArea: 'Denver metro',         hourlyRate: 58, rating: 4.7, reviewCount: 11, activities: ['Hiking', 'Farmers market walks', 'Brewery tours', 'Museum visits'],                biography: 'Botanist turned urban farmer and brewery enthusiast.',    responseTime: 'within 2h', instantBook: false, verified: true, languages: ['English'],                   acceptanceRate: 91, memberSince: 'Jun 2025', totalBookings: 37 },
    { id: 'companion-cass',    displayName: 'Cass M.',    city: 'Austin',         serviceArea: 'Austin metro',         hourlyRate: 62, rating: 4.8, reviewCount: 22, activities: ['Live music evenings', 'Food tours', 'Trail walks', 'Taco crawls'],                  biography: 'Austin musician, food writer, and live-music connoisseur.', responseTime: 'within 3h', instantBook: false, verified: true, languages: ['English', 'Spanish'],           acceptanceRate: 89, memberSince: 'Aug 2025', totalBookings: 41 },
    { id: 'companion-nadia',   displayName: 'Nadia B.',   city: 'Atlanta',        serviceArea: 'Atlanta metro',        hourlyRate: 60, rating: 4.9, reviewCount: 17, activities: ['Street art walks', 'Food & culture tours', 'Museum visits', 'Neighborhood walks'], biography: 'Atlanta native and lifelong Southerner.',               responseTime: 'within 2h', instantBook: false, verified: true, languages: ['English'],                   acceptanceRate: 94, memberSince: 'Sep 2025', totalBookings: 33 },
    { id: 'companion-finn',    displayName: 'Finn O.',    city: 'Portland',       serviceArea: 'Portland metro',       hourlyRate: 55, rating: 4.8, reviewCount: 14, activities: ['Trail walks', 'Farmers market visits', 'Bookshop tours', 'Coffee conversations'],  biography: 'Portland transplant — trails, Powell\'s, and great coffee.', responseTime: 'within 1h', instantBook: false, verified: true, languages: ['English'],                 acceptanceRate: 96, memberSince: 'Oct 2025', totalBookings: 28 },
  ];
...
function HowItWorks() {
  ...
  const FAQS: [string, string][] = [
    ...
    ['How do vibes work on the Explore page?', 'Vibes are quick-match filters that group companions by activity style — Adventurous, Cultural, Foodie, Low-key, Creative, Social, Outdoorsy, or Wellness. Picking a vibe narrows the directory to companions whose listed activities match that energy.'],
    ['What happens if a companion cancels last-minute?', 'If a companion cancels within 24 hours of a confirmed booking, you receive a full refund including the service fee, plus a $10 platform credit toward your next booking. Our care team will also help you find an available alternative.'],
  ];

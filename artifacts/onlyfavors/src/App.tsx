...
function CompareCompanions() {
  const DEV_COMPANIONS_LOCAL = [
    ...
    { id: 'companion-priya',   displayName: 'Priya M.',   city: 'Los Angeles',    serviceArea: 'LA metro',             hourlyRate: 68, rating: 4.8, reviewCount: 28, activities: ['Gallery tours', 'Rooftop dining', 'Coastal walks', 'Film & culture tours'],        biography: 'Film critic, gallery regular, and LA lifer.',             responseTime: 'within 2h', instantBook: true,  verified: true, languages: ['English', 'Hindi'],              acceptanceRate: 87, memberSince: 'Feb 2024', totalBookings: 51 },
    ...
    { id: 'companion-isadora', displayName: 'Isadora V.', city: 'Miami',          serviceArea: 'Miami-Dade',           hourlyRate: 65, rating: 4.9, reviewCount: 24, activities: ['Art walks', 'Beachside walks', 'Food & culture tours', 'Gallery visits'],          biography: 'Trilingual Miami local — art, food, and both coasts.',   responseTime: 'within 1h', instantBook: true,  verified: true, languages: ['English', 'Spanish', 'Portuguese'], acceptanceRate: 93, memberSince: 'Jun 2025', totalBookings: 78 },
    { id: 'companion-theo',    displayName: 'Theo L.',    city: 'Washington D.C.',serviceArea: 'DC metro',             hourlyRate: 72, rating: 4.7, reviewCount: 10, activities: ['Monument tours', 'Museum visits', 'Diplomatic dining', 'Gallery walks'],           biography: 'Historian, museum insider, and D.C. native.',            responseTime: 'within 3h', instantBook: false, verified: true, languages: ['English', 'French'],              acceptanceRate: 83, memberSince: 'Jul 2025', totalBookings: 29 },
